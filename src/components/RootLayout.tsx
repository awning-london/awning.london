...
function RootLayoutInner({ children }: { children: React.ReactNode }) {
  ...
  return (
    <MotionConfig transition={shouldReduceMotion ? { duration: 0 } : undefined}>
      <header>
        ...
        >
          <motion.div layout className="bg-sky-500">
            ...
            <Navigation />
            {/* <div className="relative bg-sky-600 before:absolute before:inset-x-0 before:top-0 before:h-px before:bg-sky-500">
              <Container>
      ...
      <motion.div
        layout
        style={{ borderTopLeftRadius: 40, borderTopRightRadius: 40, borderBottomRightRadius: 40, borderBottomLeftRadius: 40 }}
